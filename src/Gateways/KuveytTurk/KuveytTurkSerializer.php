...
/**
 * KuveytTürk uses XML with a <KuveytTurkVPosMessage> root element.
 */
final class KuveytTurkSerializer implements SerializerInterface
{
    public function serialize(array $data): string
    {
        $xml = new \SimpleXMLElement('<KuveytTurkVPosMessage/>');
    ...
    public function deserialize(string $payload): array
    {
        ...
        if ($xml === false) {
            throw GatewayException::unexpectedResponse('KuveytTurk', $payload);
        }
