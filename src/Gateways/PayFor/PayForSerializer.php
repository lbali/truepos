...
final class PayForSerializer implements SerializerInterface
{
    public function serialize(array $data): string
    {
        $xml = new \SimpleXMLElement('<PayforRequest/>');
    ...
    public function deserialize(string $payload): array
    {
        ...
        if ($xml === false) {
            throw GatewayException::unexpectedResponse('PayFor', $payload);
        }
